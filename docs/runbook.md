...
| 2 Generator | `python src/generator/generate.py` | `data/sample/generated/*.csv` |
...
| 7 Dashboard | `notebooks/04_dashboard.py` or `sql/dashboard/` | Read-only views |

Stage 5 (pytest) is not part of this POC slice.

## Raw files

Local CSVs: `data/sample/generated/`  
...
5. Open the dashboard (`docs/dashboard.md`).
