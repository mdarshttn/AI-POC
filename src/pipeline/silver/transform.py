...
from pipeline.silver.rules import (
    CUSTOMER_PAYLOAD,
    CUSTOMER_RULES,
    ORDER_PAYLOAD,
    ORDER_RULES,
...
def run_silver_transform(
    ...
    customers_flagged = add_customer_flags(bronze_customers)
    products_flagged = add_product_flags(bronze_products)
    ...
    orders_flagged = add_order_fk_flags(
        add_order_base_flags(bronze_orders, as_of_date=as_of_date),
        clean_customers,
        clean_products,
    )
